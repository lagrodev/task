...
public class Sparrow extends Animal {
    ...
    public Sparrow( int x, int y, final int width, final int height, Color primaryColor, Color secondaryColor) {
        super(x, y, width, height, primaryColor, secondaryColor);
    }

    public Sparrow( int x, int y, final int width, final int height, Color primaryColor, Color secondaryColor, boolean move) {
        super(x, y, width, height, primaryColor, secondaryColor);
        super.move = move;
    }
    ...
    public void lookAt(int targetX, int targetY) {
        // В данном случае воробей не реагирует на направление взгляда
        // Если требуется, можно добавить логику вращения или движения глаз
    }
